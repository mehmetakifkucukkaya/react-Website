...
return (
    <div className="text-white">
        ...
        <div className="flex justify-center items-center">
            <p className="md:text-5xl sm:text-3xl text-xl font-bold py-5">Fast, flexible financing for</p>

            <Typed className="md:text-5xl sm:text-3xl text-xl font-bold md:pl-4 pl-2 text-gray-500" strings={["BTB","BTC","SASS"]} typeSpeed={120} backSpeed={140} loop />
        </div>
